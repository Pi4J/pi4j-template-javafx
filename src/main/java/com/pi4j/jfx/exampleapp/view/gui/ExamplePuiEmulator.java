...
public class ExamplePuiEmulator extends VBox implements ViewMixin<ExampleModel, ExampleController> {

    // for each PUI component, declare a corresponding JavaFX-control
    private Label  led;
    private Button decreaseButton;

    public ExamplePuiEmulator(ExampleController controller){
        init(controller);
    }
